...
<head>
	...
	<style type="text/css">
		...
		html { 
		  background: url(img/m.jpg) no-repeat center center fixed; 
...
<body>
	...
	<form method="post" name="journeyform" onsubmit="return validate()">
        ...
        <center><form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_HAVT5dsLaZbPRc" async> </script> </form></center>
	</div>
	</body>
	</html>